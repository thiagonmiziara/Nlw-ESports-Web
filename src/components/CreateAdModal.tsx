        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          ...
          <label className='mt-2 flex gap-2 text-sm items-center'>
            <Checkbox.Root
              ...
              className='w-6 h-6 p-1 rounded bg-zinc-900 text-emerald-400'
            >
              <Checkbox.Indicator>
                <Check size={16} />
              </Checkbox.Indicator>
          ...
          <footer className='mt-4 flex justify-end gap-4'>
            <Dialog.Close
              type='button'
              className='bg-zinc-500 px-5 h-12 rounded-md font-semibold hover:animate-pulse transition-colors hover:bg-zinc-700'
            >
              Cancelar
            </Dialog.Close>
            <button
              type='submit'
              className=' flex items-center gap-3 bg-violet-500 px-5 h-12 rounded-md font-semibold hover:animate-pulse transition-colors hover:bg-violet-700'
            >
